# German (de) native-speaker auditor packet
...
## Homophones / same-sound spellings — list any (grading can then accept-any via assets/words/de/homophones.txt)  (1)

- **-** — Automated homophone detection is Spanish-only. German has real same-sound/different-spelling homophones that a spell-by-ear player could miss, but flagging them needs a native speaker + phonetic transcription. AUDITOR TASK: list any list words whose pronunciation matches another common word, so grading can accept-any (the accept-any mechanism in src/homophones.rs already supports any language via assets/words/de/homophones.txt).

## English cognates to confirm  (5)

- **12** — 'Hand' also appears in the English word lists — confirm it's a legitimate de word
- **22** — 'Wind' also appears in the English word lists — confirm it's a legitimate de word
- **23** — 'Wolf' also appears in the English word lists — confirm it's a legitimate de word
- **5** — 'Computer' also appears in the English word lists — confirm it's a legitimate de word
- **33** — 'Restaurant' also appears in the English word lists — confirm it's a legitimate de word
...
- **LANG_VOICES** — de voice = de-DE-Neural2-B (locale de-DE); configured in 1 place(s)

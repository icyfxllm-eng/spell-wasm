...
- `assets/words/profanity/tr.txt:-` [filter-layers] tr seed layer: 127 terms. Curation scan below is language-scoped (tr seed + universal hard slurs). Runtime My Words screening (src/profanity.rs is_blocked) separately uses the 1768-term all-language union — that over-block is intentional for user imports.

...
export const ALLOW = [
  ...
  { file: 'src/spelldoku/wordmode.rs', has: 'for band in [', why: 'finds the bank band of a word the player saved; serves nothing' },
  { file: 'src/spelldoku/wordmode_tests.rs', has: 'for band in [', why: 'test module: re-reads the bank to check drawn words' },
  { file: 'src/spelldoku/wordmode_tests.rs', has: 'bank("medium", 12)', why: 'test module: a My Words fixture' },

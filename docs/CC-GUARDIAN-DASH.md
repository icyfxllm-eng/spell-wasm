...
* What's next: the FSRS scheduler's upcoming review set, framed as "this week we're working on…". *[Annotated 2026-09-19, CC-LEARNING-ENGINE-L0 census C8: as built, this reads the Leitner misses queue through `reports::rematch_set`, not FSRS; it becomes FSRS when L0 R2 lands.]*

...
// It mapped 12 languages to endpoints that do not exist: dictionaryapi.dev serves
// ENGLISH ONLY, and every other language 404s. Its one caller fetched those URLs
// directly from the browser, bypassing our proxy and sending a child's word + IP
// to a third party for nothing. See game::fetch_definition and
// docs/DECISIONS-PENDING.md §10.

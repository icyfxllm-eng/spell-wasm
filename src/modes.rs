...
mod tests {
    ...
    fn little_speller_sees_only_kidsafe_modes() {
        ...
        assert_eq!(
            got,
            vec!["practice", "def_match", "letter_forge", "word_picture", "reports", "calendar", "translate"],
    ...
    fn little_speller_in_spanish_sees_the_same_pruned_menu() {
        ...
        assert_eq!(ids(&visible(&all, &c)), vec!["practice", "def_match", "letter_forge", "word_picture", "reports", "calendar", "translate"]);
    }
